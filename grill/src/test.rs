use crate::{handler::SyncHandler, schema::CompiledSchema, Compile, Handler, Location, Schema};
...
where
    F: FnOnce(&dyn SyncHandler, &mut crate::Scope, &CompiledSchema) -> Result<(), Box<dyn Error>>,
{
