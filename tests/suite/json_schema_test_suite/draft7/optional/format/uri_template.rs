...
mod format_uri_template_0 {
    ...
    #[tokio::test]
    async fn test6_a_valid_uri_template() {}
    #[tokio::test]
    async fn test7_an_invalid_uri_template() {}
    #[tokio::test]
    async fn test8_a_valid_uri_template_without_variables() {}
    #[tokio::test]
    async fn test9_a_valid_relative_uri_template() {}
}
