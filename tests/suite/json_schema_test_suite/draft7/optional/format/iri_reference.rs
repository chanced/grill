...
mod validation_of_iri_references_0 {
    ...
    #[tokio::test]
    async fn test6_a_valid_iri() {}
    #[tokio::test]
    async fn test7_a_valid_protocol_relative_iri_reference() {}
    #[tokio::test]
    async fn test8_a_valid_relative_iri_reference() {}
    #[tokio::test]
    async fn test9_an_invalid_iri_reference() {}
    #[tokio::test]
    async fn test10_a_valid_iri_reference() {}
    #[tokio::test]
    async fn test11_a_valid_iri_fragment() {}
    #[tokio::test]
    async fn test12_an_invalid_iri_fragment() {}
}
