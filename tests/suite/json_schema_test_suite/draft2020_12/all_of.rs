...
mod all_of_with_base_schema_1 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with base schema";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_simple_types_2 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf simple types";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_boolean_schemas_all_true_3 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with boolean schemas, all true";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_boolean_schemas_some_false_4 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with boolean schemas, some false";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_boolean_schemas_all_false_5 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with boolean schemas, all false";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_one_empty_schema_6 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with one empty schema";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_two_empty_schemas_7 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with two empty schemas";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_the_first_empty_schema_8 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with the first empty schema";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_with_the_last_empty_schema_9 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf with the last empty schema";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod nested_all_of_to_check_validation_semantics_10 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "nested allOf, to check validation semantics";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod all_of_combined_with_any_of_one_of_11 {
    ...
    const URI: &str = "http://localhost:1234/allOf.json";
    const DESCRIPTION: &str = "allOf combined with anyOf, oneOf";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
