...
mod min_contains_without_contains_is_ignored_0 {
    ...
    const DESCRIPTION: &str = "minContains without contains is ignored";
...
mod min_contains_1_with_contains_1 {
    ...
    const URI: &str = "http://localhost:1234/minContains.json";
    const DESCRIPTION: &str = "minContains=1 with contains";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod min_contains_2_with_contains_2 {
    ...
    const URI: &str = "http://localhost:1234/minContains.json";
    const DESCRIPTION: &str = "minContains=2 with contains";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod min_contains_2_with_contains_with_a_decimal_value_3 {
    ...
    const URI: &str = "http://localhost:1234/minContains.json";
    const DESCRIPTION: &str = "minContains=2 with contains with a decimal value";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod max_contains_min_contains_4 {
    ...
    const URI: &str = "http://localhost:1234/minContains.json";
    const DESCRIPTION: &str = "maxContains = minContains";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod min_contains_0_6 {
    ...
    const URI: &str = "http://localhost:1234/minContains.json";
    const DESCRIPTION: &str = "minContains = 0";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
...
mod min_contains_0_with_max_contains_7 {
    ...
    const URI: &str = "http://localhost:1234/minContains.json";
    const DESCRIPTION: &str = "minContains = 0 with maxContains";
    fn setup() -> Result<(Key, Interrogator), &'static CompileError> {
        use std::sync::OnceLock;
        static INTERROGATOR: OnceLock<Result<(Key, Interrogator), CompileError>> = OnceLock::new();
        INTERROGATOR
