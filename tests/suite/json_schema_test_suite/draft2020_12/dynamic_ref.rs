mod a_dynamic_ref_to_a_dynamic_anchor_in_the_same_schema_resource_behaves_like_a_normal_ref_to_an_anchor_0 {
    #[tokio::test]
    async fn test0_an_array_of_strings_is_valid() {}
    #[tokio::test]
    async fn test1_an_array_containing_non_strings_is_invalid() {}
}
...
mod a_dynamic_ref_without_anchor_in_fragment_behaves_identical_to_ref_4 {
    #[tokio::test]
    async fn test0_an_array_of_strings_is_invalid() {}
    #[tokio::test]
    async fn test1_an_array_of_numbers_is_valid() {}
}
...
mod a_dynamic_ref_that_initially_resolves_to_a_schema_with_a_matching_dynamic_anchor_resolves_to_the_first_dynamic_anchor_in_the_dynamic_scope_9 {
    #[tokio::test]
    async fn test0_the_recursive_part_is_valid_against_the_root() {}
    #[tokio::test]
    async fn test1_the_recursive_part_is_not_valid_against_the_root() {}
}
mod a_dynamic_ref_that_initially_resolves_to_a_schema_without_a_matching_dynamic_anchor_behaves_like_a_normal_ref_to_anchor_10 {
    #[tokio::test]
    async fn test0_the_recursive_part_doesn_t_need_to_validate_against_the_root() {}
}
mod multiple_dynamic_paths_to_the_dynamic_ref_keyword_11 {
    #[tokio::test]
    async fn test0_recurse_to_any_leaf_node_floats_are_allowed() {}
    #[tokio::test]
    async fn test1_recurse_to_integer_node_floats_are_not_allowed() {}
}
mod after_leaving_a_dynamic_scope_it_is_not_used_by_a_dynamic_ref_12 {
    #[tokio::test]
    async fn test0_string_matches_defs_thingy_but_the_dynamic_ref_does_not_stop_here() {}
    #[tokio::test]
    async fn test1_first_scope_is_not_in_dynamic_scope_for_the_dynamic_ref() {}
    #[tokio::test]
    async fn test2_then_defs_thingy_is_the_final_stop_for_the_dynamic_ref() {}
}
mod strict_tree_schema_guards_against_misspelled_properties_13 {
    #[tokio::test]
    async fn test0_instance_with_misspelled_field() {}
    #[tokio::test]
    async fn test1_instance_with_correct_field() {}
}
mod tests_for_implementation_dynamic_anchor_and_reference_link_14 {
    #[tokio::test]
    async fn test0_incorrect_parent_schema() {}
    #[tokio::test]
    async fn test1_incorrect_extended_schema() {}
    #[tokio::test]
    async fn test2_correct_extended_schema() {}
}
